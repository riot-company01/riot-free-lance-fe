...
const documents = {
    ...
    "query GetWork($id: Int!) @cached {\n  works_by_pk(id: $id) {\n    id\n    title\n    contractType\n    location\n    maxMonthlyPrice\n    maxWorkHours\n    minMonthlyPrice\n    minWorkHours\n    description\n    createAt\n    languages {\n      skill {\n        id\n        name\n        type\n      }\n    }\n  }\n}\n\nquery GetWorks($where: works_bool_exp = {_and: []}, $order_by: [works_order_by!] = {}) @cached {\n  works(where: $where, order_by: $order_by) {\n    id\n    title\n    contractType\n    location\n    maxMonthlyPrice\n    maxWorkHours\n    minMonthlyPrice\n    minWorkHours\n    description\n    createAt\n    languages {\n      skill {\n        id\n        name\n        type\n      }\n    }\n  }\n}": types.GetWorkDocument,
};
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetUser($id: String) @cached {\n  users(where: {id: {_eq: $id}}) {\n    id\n    name\n    last_seen\n    slackUrl\n  }\n}"): (typeof documents)["query GetUser($id: String) @cached {\n  users(where: {id: {_eq: $id}}) {\n    id\n    name\n    last_seen\n    slackUrl\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetWork($id: Int!) @cached {\n  works_by_pk(id: $id) {\n    id\n    title\n    contractType\n    location\n    maxMonthlyPrice\n    maxWorkHours\n    minMonthlyPrice\n    minWorkHours\n    description\n    createAt\n    languages {\n      skill {\n        id\n        name\n        type\n      }\n    }\n  }\n}\n\nquery GetWorks($where: works_bool_exp = {_and: []}, $order_by: [works_order_by!] = {}) @cached {\n  works(where: $where, order_by: $order_by) {\n    id\n    title\n    contractType\n    location\n    maxMonthlyPrice\n    maxWorkHours\n    minMonthlyPrice\n    minWorkHours\n    description\n    createAt\n    languages {\n      skill {\n        id\n        name\n        type\n      }\n    }\n  }\n}"): (typeof documents)["query GetWork($id: Int!) @cached {\n  works_by_pk(id: $id) {\n    id\n    title\n    contractType\n    location\n    maxMonthlyPrice\n    maxWorkHours\n    minMonthlyPrice\n    minWorkHours\n    description\n    createAt\n    languages {\n      skill {\n        id\n        name\n        type\n      }\n    }\n  }\n}\n\nquery GetWorks($where: works_bool_exp = {_and: []}, $order_by: [works_order_by!] = {}) @cached {\n  works(where: $where, order_by: $order_by) {\n    id\n    title\n    contractType\n    location\n    maxMonthlyPrice\n    maxWorkHours\n    minMonthlyPrice\n    minWorkHours\n    description\n    createAt\n    languages {\n      skill {\n        id\n        name\n        type\n      }\n    }\n  }\n}"];
