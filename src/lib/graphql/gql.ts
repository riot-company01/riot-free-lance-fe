...
const documents = {
    ...
    "query GetUserToWorks1($id: String) {\n  users(where: {id: {_eq: $id}}) {\n    userToApplyWorks {\n      workId\n    }\n    userToFavoritedWorks {\n      workId\n    }\n  }\n}\n\nquery GetUser($id: String) @cached(ttl: 0) {\n  users(where: {id: {_eq: $id}}) {\n    userName\n    userNameKana\n    mail\n    tel\n  }\n}\n\nquery GetUserToApplyWorks($id: String!) {\n  users_by_pk(id: $id) {\n    id\n  }\n}\n\nquery GetUserToWorks($id: String!) {\n  users_by_pk(id: $id) {\n    id\n    userToFavoritedWorks {\n      workId\n    }\n    userToApplyWorks {\n      workId\n    }\n  }\n}": types.GetUserToWorks1Document,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetUserToWorks1($id: String) {\n  users(where: {id: {_eq: $id}}) {\n    userToApplyWorks {\n      workId\n    }\n    userToFavoritedWorks {\n      workId\n    }\n  }\n}\n\nquery GetUser($id: String) @cached(ttl: 0) {\n  users(where: {id: {_eq: $id}}) {\n    userName\n    userNameKana\n    mail\n    tel\n  }\n}\n\nquery GetUserToApplyWorks($id: String!) {\n  users_by_pk(id: $id) {\n    id\n  }\n}\n\nquery GetUserToWorks($id: String!) {\n  users_by_pk(id: $id) {\n    id\n    userToFavoritedWorks {\n      workId\n    }\n    userToApplyWorks {\n      workId\n    }\n  }\n}"): (typeof documents)["query GetUserToWorks1($id: String) {\n  users(where: {id: {_eq: $id}}) {\n    userToApplyWorks {\n      workId\n    }\n    userToFavoritedWorks {\n      workId\n    }\n  }\n}\n\nquery GetUser($id: String) @cached(ttl: 0) {\n  users(where: {id: {_eq: $id}}) {\n    userName\n    userNameKana\n    mail\n    tel\n  }\n}\n\nquery GetUserToApplyWorks($id: String!) {\n  users_by_pk(id: $id) {\n    id\n  }\n}\n\nquery GetUserToWorks($id: String!) {\n  users_by_pk(id: $id) {\n    id\n    userToFavoritedWorks {\n      workId\n    }\n    userToApplyWorks {\n      workId\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
