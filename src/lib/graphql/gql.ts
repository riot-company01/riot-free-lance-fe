 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetFavoriteQuery($id: String) {\n  users(where: {works: {user_id: {_eq: $id}}}) {\n    works(where: {application: {_eq: true}}) {\n      application\n      favorite\n      work {\n        contractType\n        createAt\n        description\n        id\n        isClosed\n        location\n        maxMonthlyPrice\n        maxWorkHours\n        minMonthlyPrice\n        minWorkHours\n        title\n        languages {\n          skill {\n            id\n            name\n            type\n          }\n        }\n      }\n    }\n  }\n}"): (typeof documents)["query GetFavoriteQuery($id: String) {\n  users(where: {works: {user_id: {_eq: $id}}}) {\n    works(where: {application: {_eq: true}}) {\n      application\n      favorite\n      work {\n        contractType\n        createAt\n        description\n        id\n        isClosed\n        location\n        maxMonthlyPrice\n        maxWorkHours\n        minMonthlyPrice\n        minWorkHours\n        title\n        languages {\n          skill {\n            id\n            name\n            type\n          }\n        }\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
