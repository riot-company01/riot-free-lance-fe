...
const documents = {
    ...
    "mutation EditProfile($id: String!, $lastName: String, $firstName: String, $lastNameKana: String, $firstNameKana: String, $mail: String, $tel: String) {\n  update_users_by_pk(\n    pk_columns: {id: $id}\n    _set: {last_name: $lastName, first_name: $firstName, last_name_kana: $lastNameKana, first_name_kana: $firstNameKana, mail: $mail, tel: $tel}\n  ) {\n    last_name\n    first_name\n    last_name_kana\n    first_name_kana\n    mail\n    tel\n  }\n}": types.EditProfileDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation EditProfile($id: String!, $lastName: String, $firstName: String, $lastNameKana: String, $firstNameKana: String, $mail: String, $tel: String) {\n  update_users_by_pk(\n    pk_columns: {id: $id}\n    _set: {last_name: $lastName, first_name: $firstName, last_name_kana: $lastNameKana, first_name_kana: $firstNameKana, mail: $mail, tel: $tel}\n  ) {\n    last_name\n    first_name\n    last_name_kana\n    first_name_kana\n    mail\n    tel\n  }\n}"): (typeof documents)["mutation EditProfile($id: String!, $lastName: String, $firstName: String, $lastNameKana: String, $firstNameKana: String, $mail: String, $tel: String) {\n  update_users_by_pk(\n    pk_columns: {id: $id}\n    _set: {last_name: $lastName, first_name: $firstName, last_name_kana: $lastNameKana, first_name_kana: $firstNameKana, mail: $mail, tel: $tel}\n  ) {\n    last_name\n    first_name\n    last_name_kana\n    first_name_kana\n    mail\n    tel\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
