 ...
 * });
 */
export function useGetAllProjectQuery(baseOptions?: Apollo.QueryHookOptions<GetAllProjectQuery, GetAllProjectQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllProjectQuery, GetAllProjectQueryVariables>(GetAllProjectDocument, options);
      }
export function useGetAllProjectLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllProjectQuery, GetAllProjectQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useGetDetailProjectQuery(baseOptions?: Apollo.QueryHookOptions<GetDetailProjectQuery, GetDetailProjectQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetDetailProjectQuery, GetDetailProjectQueryVariables>(GetDetailProjectDocument, options);
      }
export function useGetDetailProjectLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetDetailProjectQuery, GetDetailProjectQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
