...
export type GetUserToWorksQuery = { __typename?: 'query_root', users_by_pk?: { __typename?: 'users', userToWorks: Array<{ __typename?: 'user_to_works', workId: number, favorite: boolean, application: boolean }> } | null };
