...
export type Works = {
  ...
  publish_title?: Maybe<Scalars['String']['output']>;
...
export type Works_Bool_Exp = {
  ...
  publish_title?: InputMaybe<String_Comparison_Exp>;
...
export type Works_Insert_Input = {
  ...
  minMonthlyPrice?: InputMaybe<Scalars['Int']['input']>;
  minWorkHours?: InputMaybe<Scalars['Int']['input']>;
  publish_title?: InputMaybe<Scalars['String']['input']>;
...
export type Works_Order_By = {
  ...
  publish_title?: InputMaybe<Order_By>;
