...
export type GetAppliedWorksQuery = { __typename?: 'query_root', users: Array<{ __typename?: 'users', user_to_works: Array<{ __typename?: 'user_to_works', work_id: number, favorite: boolean }> }> };
